...
const NavbarTwo = () => {
  const [menu, setMenu] = React.useState(true);const [screenWidth, setScreenWidth] = useState(0);
  useEffect(() => {
    const handleResize = () => {
  ...
  return (
    <>
      {/* Start Header Area */}
      <header className="main-header-area" style={{}}>
              ...
              <Link href="/">
                ...
                <div className="others-options d-flex align-items-center">
                  ...
                  <div className="option-item">
                    <div
                      className={styles.customOptionBar2}
        ...
        <div className="modal-dialog" role="document">
          <div className="modal-content">
            ...
            <div className="modal-body">
              <Link href="/">
                <a>
                  <img src="/images/sidebar-black-logo.png" className={styles.customModalImage} alt="image" />
                </a>
              </Link>
              ...
              <div className="sidebar-contact-info">
                ...
                <ul className="info-list">
                  ...
                  <li>
                    ...
                    <a href="mailto:info@thoughtsbig.com">info@thoughtsbig.com</a>
                  </li>
